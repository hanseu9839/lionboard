...
import org.example.lionboard.domain.BoardUpdateRequest;
...
public class BoardController {
    ...
    public String write(@Validated @ModelAttribute("board")  BoardWriteRequest form, BindingResult bindingResult, RedirectAttributes redirectAttributes){
        // 실패 로직
        ...
        redirectAttributes.addAttribute("message", "저장 완료");
    ...
    public String delete(@PathVariable Long id, @ModelAttribute("board") BoardDeleteRequest request,BindingResult bindingResult){
        ...
        if(!CryptoUtil.decrypt(board.getPassword()).equals(request.getPassword())){
